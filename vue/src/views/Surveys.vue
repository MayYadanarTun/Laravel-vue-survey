      ...
      >
        ...
        <div class="flex justify-between items-center mt-3">
          <router-link
            ...
            class="flex py-2 px-4 border border-transparent text-sm rounded-md text-sm rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-6 w-6"
